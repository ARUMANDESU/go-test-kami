...
// writeJSON encodes the data to JSON and writes it to the http.ResponseWriter.
...
// readJSON decodes the JSON request body and checks for any unknown fields.
// It also checks for a request body that is too large.
